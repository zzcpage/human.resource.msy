...
public interface StaffDao {
    ...
    public Staff findStaffById(@Param("id") long id);
     ...
     */
    @Select("select * from staff limit #{offset},#{pagesize}")
    public List<Staff> findStaffLimit(@Param("offset") int offset,@Param("pagesize") int pagesize);
     ...
     */
    @Select("select * from staff where username like CONCAT('%',#{search},'%') limit #{offset},#{pagesize}")
    public List<Staff> findStaffLimitAndSearch(@Param("offset") int offset,@Param("pagesize") int pagesize,@Param("search") String search);
     ...
     */
    @Select("select * from staff where username like CONCAT('%',#{search},'%')")
    public List<Staff> findAllStaffSearch(@Param("search") String search);
     ...
     */
    @Select("select * from staff where id in (select uid from record where cid=#{cid} ) limit #{offset},#{pagesize}")
    public List<Staff> findTeacherStaffLimit(@Param("offset") int offset,@Param("pagesize") int pagesize,@Param("cid")Long cid);
     ...
     */
    @Select("select * from staff where id in (select uid from record where cid=#{cid} ) and username like CONCAT('%',#{search},'%') limit #{offset},#{pagesize}")
    public List<Staff> findTeacherStaffLimitAndSearch(@Param("offset") int offset,@Param("pagesize") int pagesize,@Param("search") String search,@Param("cid")Long cid);
     ...
     */
    @Select("select * from staff where id in (select uid from record where cid=#{cid} ) and  username like CONCAT('%',#{search},'%')")
    public List<Staff> findAllTeacherStaffSearch( @Param("search") String search,@Param("cid")Long cid);
     ...
     */
    @Select("select * from staff where id in (select uid from record where cid=#{cid} )")
    public List<Staff> findAllTeacherStaff(@Param("cid")Long cid);
     ...
     */
    @Insert("insert into staff values(#{id},#{username},#{birthday},#{sex},#{phone},#{department})")
     ...
     */
    @Update("update staff set username=#{username} , birthday=#{birthday} , sex=#{sex} , phone=#{phone} , department = #{department} where id=#{id}")
